...
try:
    ...
    print("Error: 'thyroid_cancer_risk_data.csv' not found. Please ensure the file is in the project directory.")
    exit(1)
...
model = Sequential([
    Dense(96, activation='relu', input_shape=(X_train_balanced.shape[1],)),
    Dropout(0.25),
...
# Evaluate on test set with custom thresholds
y_pred_prob = model.predict(X_test)
thresholds = [0.42, 0.44, 0.46]  
